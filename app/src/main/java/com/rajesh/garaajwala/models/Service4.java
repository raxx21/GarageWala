...
public class Service4 {
    ...
    public void setSeat_belts(int seat_belts) {
        this.seat_belts = seat_belts;
    }
    ...
    public void setAir_condition(int air_condition) {
