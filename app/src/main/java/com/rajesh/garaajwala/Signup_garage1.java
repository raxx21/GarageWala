...
public class Signup_garage1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_signup_garage1);
    ...
    public void callNextSignupClass1Screen(View view){
        ...
        Intent intent = new Intent(getApplicationContext(), Signup_garage2.class);
...
//        MyHandler db =new MyHandler(Signup_garage1.this);
...
//        //Add Transitions
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(Signup_garage1.this, pairs);
